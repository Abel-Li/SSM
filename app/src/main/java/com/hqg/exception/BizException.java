package com.hqg.exception;

/**
 * Created by LYC on 2017/6/30.
 */
...
public class BizException extends RuntimeException {
     ...
     * 注册异常
     */
    public static final BizException REGISTER_ERROR = new BizException(10001, "注册插入异常");
    
    /**
     * 登录异常
     */
    public static final BizException LOGIN_ERROR = new BizException(100012, "登录异常");
     ...
     * @return
     */
    public Exception newInstance(String msgFormat, Object... args) {
